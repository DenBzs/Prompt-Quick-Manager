...
function buildPpcSubHtml(gi) {
    ...
    const rows = g.toggles.map((t, ti) => {
        ...
        const btnStyle = 'border:none;border-radius:3px;width:38px;min-width:38px;height:18px;font-size:10px;font-weight:700;cursor:pointer;flex-shrink:0;display:inline-flex;align-items:center;justify-content:center;box-sizing:border-box;white-space:nowrap;overflow:visible;';
        return `
