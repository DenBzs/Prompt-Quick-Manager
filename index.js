...
const PPC_THEMES = {
    dark: {
        label: '🖤',
        title: '다크',
        popup:  { border:'#38384a', upper:'#1c1c2a', lower:'#16161f', text:'#d4d0e8', shadow:'0 4px 20px rgba(0,0,0,0.55)' },
        sub:    { bg:'#1c1c2a', border:'#38384a', text:'#d4d0e8' },
        onBg:'#3d7a58', offBg:'#7a3d3d', onClr:'#e8f4ee', offClr:'#f4e8e8',
        rowBorder:'rgba(255,255,255,0.07)',
    },
    lavender: {
        label: '💜',
        title: '라벤더',
        popup:  { border:'#c4b8e0', upper:'#faf8ff', lower:'#c4b8e0', text:'#2e2848', shadow:'0 4px 16px rgba(100,80,180,0.18)' },
        sub:    { bg:'#faf8ff', border:'#c4b8e0', text:'#2e2848' },
        onBg:'#6a4eaa', offBg:'#a04868', onClr:'#fff', offClr:'#fff',
        rowBorder:'rgba(100,80,180,0.13)',
    },
    sky: {
        label: '🩵',
        title: '스카이',
        popup:  { border:'#a8cce8', upper:'#f5fbff', lower:'#a8cce8', text:'#163248', shadow:'0 4px 16px rgba(40,110,180,0.16)' },
        sub:    { bg:'#f5fbff', border:'#a8cce8', text:'#163248' },
        onBg:'#2e7aaa', offBg:'#a04050', onClr:'#fff', offClr:'#fff',
        rowBorder:'rgba(40,110,180,0.12)',
    },
    pink: {
        label: '🩷',
        title: '핑크',
        popup:  { border:'#e8b8cc', upper:'#fff6f9', lower:'#e8b8cc', text:'#3e1828', shadow:'0 4px 16px rgba(180,60,100,0.14)' },
        sub:    { bg:'#fff6f9', border:'#e8b8cc', text:'#3e1828' },
        onBg:'#aa4870', offBg:'#904040', onClr:'#fff', offClr:'#fff',
        rowBorder:'rgba(180,60,100,0.12)',
    },
    classic: {
        label: '🤎',
        title: '클래식',
        popup:  { border:'#d6cfc3', upper:'#f5f0e8', lower:'#d6cfc3', text:'#2a2a2a', shadow:'0 4px 16px rgba(0,0,0,0.18)' },
            ...
            rowsHtml = visible.map(({ g, gi }) => {
                ...
                <div style="display:flex;align-items:center;gap:7px;padding:3px 0;">
                    <button class="ppc-grp-toggle" data-gi="${gi}"
                        style="flex-shrink:0;border:none;border-radius:4px;padding:1px 6px;font-size:11px;font-weight:700;cursor:pointer;background:${bg};color:${clr};">
                        ${g.isOn ? 'On' : 'Off'}
                    </button>
    ...
    <div style="padding:12px 14px;">
        <div style="display:flex;align-items:center;gap:8px;margin-bottom:10px;">
            <button class="ppc-sub-grp-toggle"
                style="border:none;border-radius:4px;padding:2px 8px;cursor:pointer;font-size:12px;font-weight:700;flex-shrink:0;background:${grpBg};color:${grpClr};">
                ${g.isOn ? 'On' : 'Off'}
            </button>
